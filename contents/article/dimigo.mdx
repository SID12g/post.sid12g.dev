...
> 이 글은 제가 야자시간에 공부하기 싫어서 쓴 글입니다. 때문에 없을 것 같지만 만약 디미고에 관심이 있는 누군가가 이 글을 본다면 딱히 원하는 정보를 얻지 못할 것 입니다. 이를 저는 확신할 수 있습니다. 어쨌든 눌러주셔서 감사합니다. 혹시 누른게 선생님 혹은 재학생, 졸업생 분이시라면 제발 뒤로가기를 눌러주시길 바랍니다.

> 이 글은 맥락이 이상합니다. 주의해서 읽어주세요!
...
그리고 기숙사 같은 방을 사용하는 친구들을 만났었는데, 지금생각해도 3년 중 제일 재밌는 방이었고, [친구들](https://www.instagram.com/323ho_dimigo/)이었던 것 같습니다. 생일마다 서로의 생일을 축하해주며 최대한 쓸모 없는 물건들을 선물했고, 이불로 텐트를 만드는 등 저희 방보다 재밌는 방은 없었습니다. 지금 생각해보면 323호 친구들(민기, 경근, 재원, 민우, 지현)에게 너무 고맙다고 생각합니다.
