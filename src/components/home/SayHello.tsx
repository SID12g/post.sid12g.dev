    ...
    return (
        <div className={styles.wrap}>
            ...
            <div className={styles.container}>
                ...
                <p className={styles.content}>조성민의 블로그에 방문 주셔서 감사합니다! 저는 <Link href="https://nextjs.org/">Next.js</Link>와 <Link href="https://reactnative.dev/">React Native</Link>에 관심이 있습니다. 저의 포스트에서 많은 정보를 얻어가시면 좋겠습니다.🐱
                </p>
            </div>
        </div>
    )
