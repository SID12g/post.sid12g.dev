...
date: 2024년 1월 6일 (토요일)
description: React Native Firestore 오류 해결하기
image : /blogs/ReactNative-firestore-podfile-error/Thumbnail.png
tag : React Native
---
...
![PodfileCode](/blogs/ReactNative-firestore-podfile-error/PodfileCode.png)

<figcaption>[Podfile 코드](/blogs/ReactNative-firestore-podfile-error/PodfileCode.png) </figcaption>
