...
image: /contents/tech/webpack/Thumbnail.png
tag: Webpack
---
...
앞서 말했듯이 모듈 관리를 위해 Webpack이 사용됩니다. 뿐만 아니라 [다양한 포맷의 모듈](https://webpack.kr/concepts/modules/)을 지원하며, 리소스와 에셋을 동시에 처리할 수 있습니다. 또한 Webpack은 성능과 로딩시간을 중요시 생각합니다. 프로젝트와 사용자에게 최고의 경험을 제공하기 위해 비동기 청크 로딩이나 프리패칭 같은 기능을 추가하고 있습니다.

자세히 알고싶다면 [Webpack](https://webpack.kr/concepts/why-webpack/) 공식 홈페이지를 참고해주세요.
...
1. development: 개발 모드를 의미합니다. 코드가 압축되지 않은 상태이며, 난독화가 되지 않은 상태입니다.
2. production: 배포 모드를 의미합니다. 코드가 압축된 상태이며, 파일을 난독화 합니다.
3. none: mode 설정이 되지 않았음을 의미합니다. development와 비슷한 상태입니다.
...
![Powered by Webpack](/contents/tech/webpack/test.png) _debugging_

오늘은 Webpack에 대해 알아보고 사용해 보았습니다. 사실 프론트엔드 개발자에게 꼭 필요한 지식 중 하나가 Webpack이라고 생각해서 글로 정리해 보았습니다. 더 자세한 정보는 [Webpack 공식 문서](https://webpack.js.org/)를 참고해 주시길 바랍니다. 긴 글 읽어주셔서 감사합니다.
